        ...
        while True:
            ...
            while elena.mountains_north_vertical == 4:
                ...
                if inside_cave_choice.lower() == "look at skeleton":
                    ...
                    print("You try to open one of the doors, but they are locked")
                    print("---------------------------------------------------------")

                elif "look at door" in inside_cave_choice.lower:
                    print("The door seem to be hiding some valuable things you might need, behind it")
                    print("---------------------------------------------------------")

                elif inside_cave_choice.lower() == "look at iron rod":
                    print("It hangs farly light on the wall you could easly take it down")
                elif inside_cave_choice.lower() == "take iron rod":
                    cloud.key_item_2 = 1
                    cloud.key_item_2_name = "iron rod of lions"
                    print(f"You grab the {cloud.key_item_2_name} with your hands, it is fairly light but dangerous")
                    print("It could easily kill a lion")
                elif "iron rod of lions" in inside_cave_choice.lower() and cloud.key_item_2 == 1:
                    print(f"You pierce the lion door with the {cloud.key_item_2_name} and you hear a clicking sound")
